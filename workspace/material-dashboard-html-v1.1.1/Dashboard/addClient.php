...
<?php
session_start();
$_SESSION["nabvar-LeftID"]='Add Client';
$_SESSION["Sidebar-Mark"]=7;

if (isset($_GET["database"]) && $_GET["database"]==0) {
   echo "<script type='text/javascript'>alert(\"Sorry that client DNI is already on the database please use another one\");</script>";
 }
else if (isset($_GET["database"]) && $_GET["database"]==1) {
   echo "<script type='text/javascript'>alert(\"Client added succesfully!\");</script>";
 }
 ?>
<html lang="en">
<head>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Add a new client</h4>
									
	                            </div>
	                            <div class="card-content">
	                                <form name="user-form" method="POST" action="insertClient.php" enctype="multipart/form-data">
	                                    <div class="row">
	                                       <div class="col-md-3">
