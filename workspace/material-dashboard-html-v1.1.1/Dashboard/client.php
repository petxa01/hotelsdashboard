...
<?php
session_start();
$_SESSION["nabvar-LeftID"]='Client List';
$_SESSION["Sidebar-Mark"]=8;
 ?>
<html lang="en">
<head>
	<meta charset="utf-8" />
	                                        ...
	                                        <?php
	                							...
	                							while ($erregistroa=mysqli_fetch_array($result)) {
								                    ...
								                    <tr>
								                    	...
								                    	<td>%s</td>
								                    	<td>%s</td>
								                    	<td><a href=\"../assets/php/deleteClient.php?DNI=%s\"><i class=\"material-icons\">delete</i></a></td>
								                    	</tr>", $erregistroa["dni"], $erregistroa["name"], $erregistroa["surname"],$erregistroa["dni"]);
												}
