...
<?php
session_start();
$_SESSION["nabvar-LeftID"]='Add User';
$_SESSION["Sidebar-Mark"]=5;

if (isset($_GET["database"]) && $_GET["database"]==0) {
   echo "<script type='text/javascript'>alert(\"Sorry that DNI/User name is already on the database please use another one\");</script>";
 }
else if (isset($_GET["database"]) && $_GET["database"]==1) {
   echo "<script type='text/javascript'>alert(\"User added succesfully!\");</script>";
 }
 ?>
<html lang="en">
<head>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            ...
	                            <div class="card-content">
	                                <form name="user-form" method="POST" action="insertUser.php" enctype="multipart/form-data">
	                                    <div class="row">
	                                       <div class="col-md-3">
												<div class="form-group label-floating">
													<label class="control-label">Nan</label>
													<input type="text" id="nan" name="nan" class="form-control" pattern=".{9,9}">
												</div>
	                                        </div>
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
													<label class="control-label">Name</label>
													<input type="text" id="name" name="name" class="form-control" required pattern="[a-zA-Z]*" oninvalid="setCustomValidity('This box is required and does not have to contain numbers')" onchange="try{setCustomValidity('')}catch(e){}">
												</div>
	                                        </div>
	                                       <div class="col-md-5">
												<div class="form-group label-floating">
													<label class="control-label">Surname</label>
													<input type="text" id="surname" name="surname" class="form-control" pattern="[a-zA-Z]*" required oninvalid="setCustomValidity('This box is required and does not have to contain numbers')" onchange="try{setCustomValidity('')}catch(e){}">
												</div>
	                                        </div>
	                                    </div>
	                             ...
	                             <!--   <div class="col-md-4">
									...
									<input type="button" class="btn btn-info pull-right" data-toggle="collapse" data-target="#captcha" value="Im not a robot"></input>
										...
										<div id="captcha" class="collapse">
											<input type="submit" class="btn btn-primary pull-right" id="addRoom" value="Add the user"></input>
										</div>
